...
SimpleForm.setup do |config|
  ...
  config.wrappers :default, class: :input,
    ...
    b.wrapper :tag => 'div', :class => 'form-group form-float' do |ba|
      ba.wrapper :tag => 'div', :class => 'form-line', error_class: 'error' do |bb|
      ...
      ba.use :hint,  :wrap_with => { :tag => 'label', :class => '' }
    end
  ...
  config.wrappers(:vertical_collection, tag: 'div',
    ...
    b.use :label_text, wrapper: false
    b.use :input, wrapper: false
    b.use :error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    b.use :hint,  wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end

  config.wrappers(:checkbox, :tag => 'div', :class => 'form-group form-float') do |ba|
